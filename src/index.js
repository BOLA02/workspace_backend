...
app.listen(PORT, () => {
  ...
  console.log(`\n Workspace Types:`);
  console.log(`   GET    /api/workspace-types`);
  console.log(`   POST   /api/workspace-types (admin)`);
  console.log(`   PUT    /api/workspace-types/:id (admin)`);
  console.log(`   DELETE /api/workspace-types/:id (admin)`);
  console.log(`\n Bookings:`);
  console.log(`   POST   /api/bookings`);
  console.log(`   GET    /api/bookings`);
  console.log(`   GET    /api/bookings/:id`);
  console.log(`   PUT    /api/bookings/:id (admin)`);
  console.log(`   DELETE /api/bookings/:id (admin)`);
  console.log(`\n Export:`);
  console.log(`   GET    /api/bookings/export/csv`);
  console.log(`   GET    /api/bookings/export/json`);
  console.log(`\n Expenses:`);
  console.log(`   POST   /api/expenses (admin)`);
  console.log(`   GET    /api/expenses (admin)`);
  console.log(`   PUT    /api/expenses/:id (admin)`);
  console.log(`   DELETE /api/expenses/:id (admin)`);
  console.log(`\n Analytics:`);
  console.log(`   GET    /api/analytics/stats (admin)`);
  console.log(`   GET    /api/analytics/staff-performance (admin)`);
});